...
// go fmt ./... && go vet ./... && go test ./... && go build 345.go && time ./345
// go fmt ./... && go vet ./... && go test ./... && go build 345.go && ./345 && echo top | go tool pprof cpu.prof
...
//
//    7   53   183   439 _863_
//  497 _383_  563    79  973
//  287   63  _343_  169  583
//  627  343   773  _959_ 943
// _767_ 473  103   699   303
//
...
// The solution is to apply the Hungarian Algorithm. Treat each
// element as a "cost" and optimize to find the maximal
// assignment of costs.
